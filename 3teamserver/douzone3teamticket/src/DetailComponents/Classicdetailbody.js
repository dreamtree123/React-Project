...
function Classicdetailbody(){
    ...
    <table className="table">
        <div>
            <div className="rn-07">
                {visible ? <a href="rn-tab01" className="on">
                <NavLink onClick={()=>{setClickTab(0);setvisible(true);}}>
                        <span>상세정보</span>
                    </NavLink>
                </a> : <a href="rn-tab01" className="off">
                    <NavLink onClick={()=>{setClickTab(0);setvisible(true);}}>
                        <span>상세정보</span>
                    </NavLink>
                </a>}
  ...
  return (
      <div className= {`start  ${fade}`} >
        {[<div><div className="rn-tab-boxes">
                <div className="rn-tab-area rn-08 on" id="rn-tab01">
                    <div className="rn-0801">
                        <p className="rn08-tit" id="titPerfNotice">유의사항</p>

                        <div className="rn08-txt" >
                            <div className="rn08-txt" >
                                <p className="rn-blue">※ 본 공연은 가상계좌 입금 마감 시간이 예매 당일 23시 29분이오니, 무통장 입금 선택 예매 시 착오 없으시기 바랍니다.</p>
                                <br />
                                <p className="rn-blue">※ 본 공연은 네이버 쿠폰이 적용되지 않습니다.</p>
                                <p>
                                    <b>
                                        <span color="red">※ 라이브네이션 선예매는 무통장입금이 불가합니다. </span>
                                    </b>
                                </p>
                                <p className="rn-blue">※ 본 공연은 YES24공연에서 진행하는 할인쿠폰이벤트 대상에서 제외됩니다.</p>
                                <br />
                                <p>※ 매수제한 : 1인 4매</p>
                    ...
                    <div className="rn-0802">
                        <p className="rn08-tit" id="titPerfPromotion">할인정보</p>
                        <div className="rn08-txt" id="divPerfPromotion">
                    ...
                    <div className="rn-0805">
                        <p className="rn08-tit">상품정보제공 고시</p>
                        <div className="rn08-txt">
                            <div className="rn08-tbl rn08-tbl-plus">
                                <table>
                                    <caption></caption>
                                    <colgroup>
                                        <col width="18.5%" />
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row" className="rn08-tbl-tit2">주최/기획</th>
                                            <td>{find.agencyinfo}</td>
                                            <th scope="row" className="rn08-tbl-tit2">소비자상담</th>
                                            <td>{find.consultation}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row" className="rn08-tbl-tit2">주연</th>
                                            <td>{find.cast}</td>
                                            <th scope="row" className="rn08-tbl-tit2">관람등급</th>
                                            <td>{find.rate}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row" className="rn08-tbl-tit2">공연시간</th>
                                            <td>{find.showtime}</td>
                                            <th scope="row" className="rn08-tbl-tit2">공연장소</th>
                                            <td>{find.place}</td>
                                        </tr>
                                        <tr><th scope="row" className="rn08-tbl-tit2">취소/환불방법</th><td colspan="3">
                                            <div className="rn08-detail-box">
                                                <p>
                                                ...
                                                <div className="rn08-detail-tbl">
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr><td>예매 후 8일 ~ 관람일 10일 전까지</td><td>뮤지컬, 콘서트, 클래식 등: <span className="rn-red">장당 4,000원</span> / <br />연극, 전시 등: <span className="rn-red">장당 2,000원</span>(단, 티켓 금액의 10% 이내)</td></tr>
                    ...
                    <div className="rn-0806">
					    <div className="rn-1101">
						    <p className="rn-1101-tit">
                                <span id="TheaterName">{find.place}</span>
                            </p>
						    <p className="rn-1101-other">
                                <span id="TheaterAddress">{find.placeadr} </span>
                                <span id="TheaterTel">{find.placeconsultation} </span>
                                
                            </p>
					    </div>
					    <div className="rn-1103">
                            <div className="rn-1103-btns">
                ...
                <div className="rn-tab-area rn-12 off" id="rn-tab05">
                </div>
            </div>
            <div className="pop-alert">
            </div>
            </div>, <div>
            <div className="rn-tab-area rn-12 on" id="rn-tab05">
    <div className="rn-1201 rn-infos-1">
        <div className="rn12-left-tit">예매</div>
        <div className="rn12-right-box">
            ...
            <br />
			<span className="rn12-right-underline">무통장입금 결제 선택 시 입금 마감시간은 예매일 익일 밤 11시 29분까지
            </span>
	...
	<div className="rn-1201 rn-infos-2">
		<div className="rn12-left-tit">티켓수령방법</div>
			<div className="rn12-right-box">
				<div className="rn12-line"></div>
				<p>
                    <span className="rn12-right-bold">현장수령 </span>
				    티켓은 예매자 본인 수령이 기본 원칙입니다.
                    <br />
					공연 당일 예매확인서와 예매자의 신분증 을 지참하신 후 공연장 매표소에서 티켓을 수령하시면 됩니다.
                </p>
				<p>
                    <span className="rn12-right-bold">배송</span>
		...
		<div className="rn-1201 rn-infos-3">
			<div className="rn12-left-tit">취소마감시간</div>
			<div className="rn12-right-box">
				<div className="rn12-line"></div>
				<div className="rn12-tbl">
					<table>
					    ...
					    <tbody>
							...
							<tr>
                                ...
                                <td >공휴일 전일이 평일인 경우 - 오후 5시
                                    ...
                                    <br />
                                    <span className="rn12-right-red">공휴일에는 예매 취소 불가</span>
                                </td>
                            </tr>
						</tbody>
					</table>
				...
				<span className="rn12-right-red rn12-caution">
		...
		<div className="rn-1201 rn-infos-4">
			<div className="rn12-left-tit">취소수수료</div>
			<div className="rn12-right-box">
			    <div className="rn12-line"></div>
				<div className="rn12-tbl">
					<table>
						...
						<tbody>
							...
							<tr>
                                <td className="rn-color-333">예매 후 7일 이내</td>
                                <td>없음</td>
                            </tr>
							<tr>
                                <td className="rn-color-333">예매 후 8일 ~ 관람일 10일 전까지</td>
                ...
                <br/>
				<span className="rn12-right-red">상품의 특성에 따라 취소수수료 정책이 달라질 수 있습니다.(각 상품 예매 시 취소수수료 확인)</span>
			</div>
		</div>
		<div className="rn-1201 rn-infos-5">
			<div className="rn12-left-tit">환불</div>
			<div className="rn12-right-box">
				<div className="rn12-line"></div>
				...
				<div className="rn12-tbl">
					<table>
					    ...
					    <tbody>
							...
							<tr>
                                <td className="rn-color-333">신용카드</td>
                                <td>
                                    <p>
							...
							<tr>
                                <td className="rn-color-333">무통장입금</td>
                                <td >
									<p>
